@foreach($products as $product)
    <div class="bp-cards card border p-3 p-lg-5 mb-5" id="{{$product->Item_number}}">
        ...
        @if($product->audios()->count() > 1)
            ...
            <div class="col-lg-12">
                <a class="pt-2 link link-collapse collapse-rewrite-audio collapsed font-size-1 font-weight-bold pt-1"
                   data-bs-toggle="collapse" collapce-first-3="collapseAudioItem{{$product->Item_number}}"
                   href="#collapseAudioItem{{$product->Item_number}}" role="button" aria-expanded="false"
                   aria-controls="collapseDescriptionSection-1">
        ...
        <div style="">
            ...
            <div class="col-lg-12">
                <a class="pt-3 link link-collapse collapse-rewrite collapsed font-size-1 font-weight-bold pt-1"
                   data-bs-toggle="collapse"
                   collapce-first-3="collapseCourseDescriptionSection{{$product->Item_number}}"
                   href="#collapseCourseDescriptionSection{{$product->Item_number}}" role="button" aria-expanded="false"
                   aria-controls="collapseDescriptionSection-1">
